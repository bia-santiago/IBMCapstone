...
app.layout = html.Div(children=[
    ...
    html.Div([
        ...
        html.Div([
            ...
            html.Div(
                [
                html.H2('Site:', style={'margin-right': '2em'}),
                ]
            ),
            dcc.Dropdown(
                id='site-dropdown',
...
def get_scatter_polt(entered_site,entered_range):
    vmin = entered_range[0]
    vmax = entered_range[1]
    filtered_df = spacex_df[(spacex_df['Payload Mass (kg)'] > vmin) & (spacex_df['Payload Mass (kg)'] < vmax)]
    if entered_site == 'ALL':
